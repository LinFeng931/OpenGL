...
public:
	...
	void setRotate(const glm::mat4& rotMatrix);
...
protected:
	...
	GLint _diffMapLoc;	// diffuse 啟動參數的進入點
	GLint _lightMapLoc; // light map 啟動參數的進入點
	GLint _normalMapLoc; // normal map 啟動參數的進入點
	GLint _cubicMapLoc; // cubic map 啟動參數的進入點
};